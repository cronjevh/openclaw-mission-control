...
async def start_onboarding(
    ...
    prompt = (
        ...
        "You are the gateway agent. Read the board name and description carefully.\n"
        "If the board description already provides a clear goal, workflow, and scope,\n"
        "do NOT ask redundant questions about the goal — treat it as already answered.\n"
        "Instead, focus on what is still unknown.\n\n"
        "Ask 4-8 focused questions total (fewer if the description is detailed):\n"
        "- 0-3 questions to clarify the board goal ONLY if the description is vague or missing.\n"
        "  If the description already defines the goal clearly, skip these entirely.\n"
        "- 1-3 questions specific to the board's domain (e.g., for a templates board:\n"
        "  which repos to prioritize, coding standards, review process).\n"
        "- 1 question to choose a unique name for the board lead agent "
        "(first-name style).\n"
        "- 2-3 questions to capture the user's preferences for how the board "
        "lead should work\n"
